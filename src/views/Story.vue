...
<div class="preText">
  <h6>Његов научни рад углавном се базирао на филозофским и астрономским истраживањима и закључцима. Био је под великим утицајем дела Николе Коперника од кога је прихватио хелиоцентрични систем, односно систем у чијем је средишту Сунце, а око кога круже Земља и остале планете</h6>
  <h6>{{check}}</h6>
</div>
